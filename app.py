...
def download_client():
    ...
    <body>
        <div class="container">
            ...
            <div class="info-box">
                <h2>Game Client</h2>
                <p>To play the full version of Cloud Defender with graphics and sound, visit our GitHub repository:</p>
                
                <div class="repo-link">
                    <a href="https://github.com/aws-samples/cloud-defender-game" target="_blank">
                        https://github.com/aws-samples/cloud-defender-game
                    </a>
                </div>
                
                <p>The repository contains:</p>
                <ul>
                    <li>Complete game client with all assets</li>
                    <li>Installation instructions</li>
                    <li>Deployment scripts for your own AWS environment</li>
                    <li>Documentation on game features and architecture</li>
                </ul>
            </div>
