...
REPOSITORY_NAME="cloud-defender"
S3_BUCKET="${STACK_PREFIX}-cfn-$(aws sts get-caller-identity --query Account --output text)"
...
echo "Note: It may take a few minutes for the service to be available."
